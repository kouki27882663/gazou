...
class _EvaluationState extends State<Evaluation> {
  ...
  double _Closeness_calculation(){
    ...
    var point2;
    var point3;
    if(isdir_backhand=="Left"){//もし右側の特徴点座標を使うなら2を原点として，1と3がなす角度
  ...
  List<String> _advice(){
    ...
    = ["",
      "真横から見たとき耳たぶ・肩峰（肩口/肩先）・股関節・膝・外くるぶしの５cm前の5点が床から一直線に並ぶのが理想的な姿勢です。",
    ...
    = ["",
      "かなりの左右差があるため顎を引き、背すじを伸ばし、肩を軽く下げる姿勢を保つことが重要です。",
      "左右差があるため背すじを伸ばし、肩を軽く下げる姿勢を保つことが重要です。",
      "やや左右差があるため背中をまっすぐ伸ばし、肩を軽く下げる姿勢を保つことが重要です。",
    ];
                              ...
                              RadarChartData( 
                                ...
                                dataSets: [
                                  RadarDataSet(
                                    ...
                                    borderWidth: 4,
                                    dataEntries: [
                                      RadarEntry(value: (_triangular_chart()[5]-4).abs()),
                                      RadarEntry(value: (_triangular_chart()[6]-4).abs()),
                                      RadarEntry(value: (_triangular_chart()[7]-4).abs()),
                                      RadarEntry(value: 4),
                                      RadarEntry(value: 4),
